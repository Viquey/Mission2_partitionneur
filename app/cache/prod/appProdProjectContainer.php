...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_1' => 'get2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b5021Service',
            '2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_2' => 'get2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b5022Service',
            '2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_3' => 'get2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b5023Service',
    ...
    protected function get2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b5021Service()
    {
        return $this->services['2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }
    protected function get2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b5022Service()
    {
        return $this->services['2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }
    protected function get2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b5023Service()
    {
        return $this->services['2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    protected function getAnnotationReaderService()
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/sio/public_html/Mission2/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/sio/public_html/Mission2/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/sio/public_html/Mission2/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/sio/public_html/Mission2/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4dcfb092087521581324cd9a93236448815dab40614ad0ae06b7ce23968345b0');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4dcfb092087521581324cd9a93236448815dab40614ad0ae06b7ce23968345b0');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4dcfb092087521581324cd9a93236448815dab40614ad0ae06b7ce23968345b0');
        ...
        $d->setProxyDir('/home/sio/public_html/Mission2/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/sio/public_html/Mission2/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/sio/public_html/Mission2/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('event_dispatcher'));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/sio/public_html/Mission2/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/sio/public_html/Mission2/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_1'), 1 => $this->get('2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_2'), 2 => $this->get('2f3283f933203b4dab26467bc684511d84474f5c08a0e87809908eca4f60b502_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/sio/public_html/Mission2/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/sio/public_html/Mission2/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/sio/public_html/Mission2/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/sio/public_html/Mission2/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/sio/public_html/Mission2/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/sio/public_html/Mission2/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/sio/public_html/Mission2/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/sio/public_html/Mission2/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/sio/public_html/Mission2/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/sio/public_html/Mission2/src/Org/FormaBundle/Resources/views', 'OrgForma');
        $instance->addPath('/home/sio/public_html/Mission2/src/Org/UserBundle/Resources/views', 'OrgUser');
        $instance->addPath('/home/sio/public_html/Mission2/src/Org/PartitioneurBundle/Resources/views', 'OrgPartitioneur');
        $instance->addPath('/home/sio/public_html/Mission2/app/Resources/views');
        $instance->addPath('/home/sio/public_html/Mission2/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/sio/public_html/Mission2/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/sio/public_html/Mission2/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/sio/public_html/Mission2/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/sio/public_html/Mission2/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/sio/public_html/Mission2/app/cache/prod',
            'kernel.logs_dir' => '/home/sio/public_html/Mission2/app/logs',
            ...
            'session.save_path' => '/home/sio/public_html/Mission2/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/sio/public_html/Mission2/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/sio/public_html/Mission2/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/home/sio/public_html/Mission2/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/sio/public_html/Mission2/app/cache/prod/assetic',
            ...
            'assetic.read_from' => '/home/sio/public_html/Mission2/app/../web',
            'assetic.write_to' => '/home/sio/public_html/Mission2/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/sio/public_html/Mission2/app/cache/prod/doctrine/orm/Proxies',
